...
export const HeroSection: FunctionalComponent = () => {
  ...
  return (
    <section class="flex flex-col items-center space-y-14 pt-16">
      <PageHeading title={t("home_page_title")} subtitle={t("home_page_subtitle")} class="" />
      <div class="flex flex-col items-center space-y-14 sm:flex-row sm:space-y-0">
        <ScrollReveal delay={1} direction="down" class="shrink-0">
          <Image
        ...
        <ScrollReveal
          delay={1.5}
          class="max-w-sm text-left text-sm sm:max-w-xl sm:pl-14 sm:text-base"
        >
